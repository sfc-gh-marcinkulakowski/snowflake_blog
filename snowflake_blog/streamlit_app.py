...
def create_table():
    c.execute('CREATE TABLE IF NOT EXISTS blogtable(author TEXT,title TEXT,article TEXT,postdate DATE NULL)')
...
def main():
    ...
    html_temp = """
        ...
        <h1 style="color:{};text-align:center;">Streamlit/Snowflake Blog </h1>
        </div>
        """
